...
return [
    ...
    |
    */
    'password'        => 'Пароли должны содержать не менее восьми символов.',
    ...
    'email_not_found' => 'Мы не можем найти пользователя с этим адресом электронной почты.',
    'not_match'       => 'Старый пароль не должен совпадать с новым паролем.',
];
